                ...
                {result.sources.map((s) => (
                  <li key={s.messageId}>
                    <button
                      ...
                      className="group flex w-full items-start gap-2 rounded-lg border bg-card/30 px-3 py-2 text-left transition-colors hover:border-primary/30 hover:bg-card"
                    >
    ...
    if (source) {
      out.push(
        <button
          ...
          className="mx-0.5 inline-flex h-4 min-w-4 items-center justify-center rounded-full bg-primary/20 px-1 align-baseline text-[10px] font-semibold text-primary transition-colors hover:bg-primary/30 hover:text-primary"
      ...
      <div className="flex flex-wrap justify-center gap-1.5 pt-1">
        {examples.map((q) => (
          <button
            ...
            type="button"
            onClick={() => onPick(q)}
            className="rounded-full border border-border/60 bg-card/30 px-2.5 py-1 text-xs text-muted-foreground transition-colors hover:border-primary/40 hover:bg-card/60 hover:text-foreground"
          >
            {q}
          </button>
        ))}
